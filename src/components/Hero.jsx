...
const Hero = () => {
    ...
    useGSAP(() => {
        gsap.set( '#video-frame', {
            clipPath: 'polygon(14% 0%, 72% 0%, 100% 85%, 0% 100%)',
  ...
  return (
    <div className='relative h-dvh w-screen overflow-x-hid'>
        {isLoading && (
            ...
            <div className='absolute left-0 top-0 z-40 size-full'>
                <div className='mt-24 px-5 sm:px-10'>
                    ...
                    <p className='mb-5 max-w-64 font-robert-regular text-blue-100' >
                        Enter the world of darkness <br />
                        Unleash the madness
                    </p>
                    <Button id='watch-trailer' title='Watch Struggle' leftIcon={<TiLocationArrow />} 
